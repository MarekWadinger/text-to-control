...
- **Integral Square Error (ISE)**:
  \[
  J = \int*0^{T*{sim}} (r(t) - y(t))^2 \, dt
  \]

- **Integral Absolute Error (IAE)**:
  \[
  J = \int*0^{T*{sim}} |r(t) - y(t)| \, dt
  \]

- **Integral Time-weighted Absolute Error (ITAE)**:
  \[
  J = \int*0^{T*{sim}} t \cdot |r(t) - y(t)| \, dt
  \]

- **Integral Time-weighted Square Error (ITSE)**:
  \[
  J = \int*0^{T*{sim}} t \cdot (r(t) - y(t))^2 \, dt
  \]

- **Mean Squared Error (MSE)**:
  \[
  J = \frac{1}{T*{sim}} \int_0^{T*{sim}} (r(t) - y(t))^2 \, dt
  \]
